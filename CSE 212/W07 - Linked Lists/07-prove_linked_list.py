...
class LinkedList:
    ...
    def remove(self, value):
        ...
        while curr is not None:
            if curr.data == value:
                # Check if value is at the beginning of the list
                if curr == self.head:
                    self.remove_head()
                # Check is value is at the end of the list
                elif curr == self.tail:
                    self.remove_tail()
                # Procedure for all other locations
                else:
                    curr.next.prev = curr.prev
                    curr.prev.next = curr.next 
                return
            curr = curr.next # Set next node
    ...
    def replace(self, old_value, new_value):
        ...
        while curr is not None:
            # If a match is found then switch the value to new_value
