...
class Queue:
    ...
    def enqueue(self, value):
        ...
        """
        #self.queue.insert(0, value)  --- Defect #1
...
# Defect(s) Found: Switched insert funstion with append.
...
# Defect(s) Found: Changed > 1 to != 1

print("=================")

# Test 4
# Scenario: Try to get the next person from an empty queue
# Exepcted Result: No one in queue
print("Test 4")

players = Taking_Turns_Queue()
players.get_next_person()

# Defect(s) Found: I dont think there are any.